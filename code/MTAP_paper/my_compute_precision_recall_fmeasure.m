...
true_positive = count_tp/(row * col);
false_positive = count_fp/(row * col);
true_negeative = count_tn/(row * col);
false_negeative = count_fn/(row * col);
% precision
...
% output
%
temp_obj_eval.TP = true_positive;
temp_obj_eval.FP = false_positive;
temp_obj_eval.TN = true_negeative;
temp_obj_eval.FN = false_negeative;
